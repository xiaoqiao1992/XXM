...
@property (nonatomic, strong) QQBannerFooter *footer;
...
{
    QQBannerCell*cell = [collectionView dequeueReusableCellWithReuseIdentifier:banner_item forIndexPath:indexPath];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)theCollectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)theIndexPath
{
    ...
    if(kind == UICollectionElementKindSectionFooter)
    {
        ...
        self.footer = (QQBannerFooter *)footer;
        
        // 配置footer的提示语
        if ([self.dataSource respondsToSelector:@selector(banner:titleForFooterWithState:)]) {
            self.footer.idleTitle = [self.dataSource banner:self titleForFooterWithState:QQBannerFooterStateIdle];
            self.footer.triggerTitle = [self.dataSource banner:self titleForFooterWithState:QQBannerFooterStateTrigger];
        }
    }
 ...
 *  数据源
 */
- (void)setDataSource:(id<QQBannerViewDataSource>)dataSource
{
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        // 注册cell
        [_collectionView registerClass:[QQBannerCell class] forCellWithReuseIdentifier:banner_item];
