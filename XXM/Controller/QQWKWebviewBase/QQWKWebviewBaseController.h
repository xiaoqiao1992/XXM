...
@interface QQWKWebviewBaseController : UIViewController<WKUIDelegate,WKNavigationDelegate,QQWKWebViewMessageHandleDelegate>

@property (nonatomic, strong) QQWKWebView *webView;
